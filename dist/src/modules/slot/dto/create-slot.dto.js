...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Morning Batch 1' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateSlotDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '06:30', description: 'Format HH:mm' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Matches)(/^([01]\d|2[0-3]):([0-5]\d)$/, { message: 'startTime must be in HH:mm format' }),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Matches)(/^([01]\d|2[0-3]):([0-5]\d)$/, { message: 'endTime must be in HH:mm format' }),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
