...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new delivery slot' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a delivery slot' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Soft delete a delivery slot' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
...
exports.SlotController = SlotController = __decorate([
    (0, swagger_1.ApiTags)('Admin Delivery Slots'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN),
    (0, common_1.Controller)('admin/slots'),
